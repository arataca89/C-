...
### Arquivos
- lista_encadeada.hpp - contém as definições da classe <font color="#00ff00">Node</font>, que representa um nó da lista, e da classe <span style="color: yellow;"><tt>Lista</tt></span> que possui as funcionalidades da lista encadeada genérica;
